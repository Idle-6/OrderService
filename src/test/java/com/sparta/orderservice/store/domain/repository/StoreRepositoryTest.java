...
class StoreRepositoryTest {
    ...
    void findStorePage() {
        ...
        Page<ResStoreDtoV1> response = storeRepository.findStorePage(searchParam, PageRequest.of(0, 5, Sort.by(Sort.Direction.DESC, "createdAt")), false);
    ...
    void findStorePage_manager() {
        SearchParam searchParam = new SearchParam();
        Page<ResStoreDtoV1> response = storeRepository.findStorePage(searchParam, PageRequest.of(0, 5, Sort.by(Sort.Direction.DESC, "createdAt")), true);
